...
Want deeper insights into your dividend portfolio? You can use AI assistants like KIRO, ChatGPT, or Claude to analyze your exported CSV data and create comprehensive reports in multiple formats!

### Generate Professional Portfolio Reports

1. **Export your dividend history** from IG as described above
2. **Upload the CSV file** to your preferred AI assistant (KIRO, ChatGPT, Claude, etc.)
3. **Request analysis and specify format**, for example:
   ```
   "Can you analyze this dividend transaction history CSV and provide key takeaways in [format]?"
   ```

### Available Report Formats

Ask the AI to generate your analysis in any of these formats:

#### 📊 **Interactive HTML Presentation**
- Slideshow format with navigation controls
- Perfect for presenting to others or online sharing
- Visual charts and professional styling
- **Request:** "Create an interactive HTML slide presentation"

#### 📝 **Markdown Report**
- GitHub-compatible format
- Easy to convert to other formats (PDF, Word, etc.)
- Clean, structured documentation
- **Request:** "Generate a detailed markdown report"

#### 🖨️ **PDF-Ready HTML**
- Optimized for printing to PDF
- Professional report layout with page breaks
- Suitable for formal documentation
- **Request:** "Create a PDF-ready HTML report I can print"

#### 📄 **Plain Text Report**
- Universal compatibility
- Easy to email or paste anywhere
- Simple, readable format
- **Request:** "Provide a plain text summary report"

#### 📋 **Additional Formats**
- **LaTeX Beamer:** For academic presentations
- **CSV Summary:** Key metrics in spreadsheet format
- **JSON Data:** For further programmatic analysis

### What You'll Get in Any Format

The AI analysis will include:
- **Portfolio evolution timeline** showing your investment journey
- **Top dividend contributors** and their performance over time
- **Geographic diversification** analysis (domestic vs international)
- **Income frequency breakdown** (monthly, quarterly, annual payments)
- **Growth metrics** and position scaling achievements
- **Strategic insights** into your investment discipline and evolution

### Example Analysis Features
- Investment consistency over multiple years
- Strategic shifts in portfolio composition
- Dividend growth patterns and trends
- Risk diversification assessment
- Income optimization strategies
- Quality focus and blue-chip selection

### Pro Tips for Better Analysis
- **Be specific about format:** "Create a PDF-ready HTML report with tables"
- **Request multiple formats:** "Generate both a slideshow and markdown version"
- **Ask for customization:** "Focus on the income growth aspect in the analysis"
- **Specify audience:** "Make it suitable for sharing with a financial advisor"

This AI-powered analysis complements the basic charts generated by this tool, providing strategic insights into your long-term dividend investing journey in whatever format works best for your needs.
